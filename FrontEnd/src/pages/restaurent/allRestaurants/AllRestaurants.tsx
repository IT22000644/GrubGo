...
import { Star, MapPin, Phone, Clock, ChevronRight, Search } from "lucide-react";
  ...
  return (
    <div className="mt-10 min-h-screen pb-12 pt-20">
      <div className="items-center text-center">
        <h1 className="text-3xl font-bold mb-2 text-text_dark">
        ...
        <div className="relative max-w-2xl mx-auto my-8">
          ...
          <input
            ...
            className="w-full py-3 pl-10 pr-4 rounded-full bg-white text-gray-800 shadow-md focus:outline-none focus:ring-2 focus:ring-primary"
            value={searchTerm}
          ...
          filteredRestaurants.map((restaurant) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <button
                  className="w-full py-2 bg-primary/10 text-primary rounded-lg flex items-center justify-center font-medium hover:bg-primary/40 transition-colors"
