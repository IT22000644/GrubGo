    ...
    <div className="min-h-screen flex flex-col justify-center items-center text-gray-800 dark:text-white px-4">
      <div className="max-w-md w-full text-center">
        <div className="mb-8 relative mx-auto w-48 h-48">
          <div className="absolute inset-0 rounded-full bg-gray_800 dark:bg-gray-800 shadow-inner"></div>
        ...
        <h1 className="text-6xl font-bold mb-2 text-orange-400 dark:text-orange-500 dark:text-accent">
          404
        </h1>
        <h2 className="text-2xl font-semibold mb-4 text-text_white">
          Order Not Found!
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="flex items-center justify-center px-6 py-3 bg-orange-400 hover:bg-orange-500 dark:bg-accent dark:hover:bg-accent/50 text-white rounded-full shadow-md transition-all duration-300 hover:shadow-lg"
          >
